...
/**
* Custom option component for filter dropdowns with radio-style selection indicator.
...
*/
function FiltersCustomOption (props) {
...
export default memo(FiltersCustomOption);
