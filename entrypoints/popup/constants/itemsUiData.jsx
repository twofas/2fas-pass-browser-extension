...
* @return {Object} The items UI data object with localized labels.
*/
const getItemsUiData = getMessage => ({
  Login: {
  ...
  PaymentCard: {
    label: getMessage('payment_card'),
    selectClassName: 'icon-item-payment-card',
    svg: <PaymentCardIcon />
  },
  SecureNote: {
    label: getMessage('secure_note'),
