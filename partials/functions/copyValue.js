...
* @param {string} itemType - The type of the item being copied ('password', 'username', 'uri', 'name', 'text', 'cardNumber', 'expirationDate', 'securityCode', 'cardHolder', 'wifiPassword', 'ssid').
* @return {Promise<void>}
*/
