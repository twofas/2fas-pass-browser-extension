...
*/
const updateDataAddedInAnotherVault = async (state, messageId) => {
  try {
    ...
    return {
      returnUrl: '/',
      returnToast: {
        text: browser.i18n.getMessage('fetch_update_login_added_in_another_vault_toast'),
        type: 'success'
      }
    };
  } catch (e) {
    throw new TwoFasError(TwoFasError.errors.pullRequestActionUpdateLoginAddedInAnotherVaultError, { event: e });
  }
};

export default updateDataAddedInAnotherVault;
